...
from bbb_train import (
    MultiModalGMLPFromFlat, predict_probs, roc_auc_from_probs,
...
def main(model_dir, output_path):
    ...
    for seed in SEEDS:
        ...
        # Internal test — test_ds already normalized by split_then_normalize
        X_test = test_ds.tensors[0]
        y_test = test_ds.tensors[1].numpy().astype(int)

        # Ext / holdout — raw features, apply saved scaler
